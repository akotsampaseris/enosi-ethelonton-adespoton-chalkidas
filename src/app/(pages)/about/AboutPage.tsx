    ...
    const values = [
        {
            icon: Heart,
            title: "Συμπόνια",
            description: "Κάθε ζώο αξίζει αγάπη, φροντίδα και μια δεύτερη ευκαιρία για ευτυχία.",
        },
        {
            icon: Target,
            title: "Δέσμευση",
            description: "Είμαστε αφοσιωμένοι στο να βρούμε το τέλειο σπίτι για κάθε διασωθέν ζώο.",
        },
        {
            icon: Users,
            title: "Κοινότητα",
            description: "Μαζί με τους εθελοντές και τους υποστηρικτές μας, κάνουμε πραγματική διαφορά.",
        },
        {
            icon: Sparkles,
            title: "Διαφάνεια",
            description: "Λειτουργούμε με ειλικρίνεια και ορατότητα σε όλα όσα κάνουμε.",
        },
    ];
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <motion.div
                            ...
                            <p className="text-lg text-gray-700 leading-relaxed mb-6">
                                ...
                                υπηρεσιών υιοθεσίας μας, έχουμε βοηθήσει εκατοντάδες ζώα να βρουν τις οικογένειές τους.
                            </p>
                            <p className="text-lg text-gray-700 leading-relaxed">
                                Το έργο μας είναι δυνατό χάρη στην αφοσίωση των εθελοντών μας, τη γενναιοδωρία των συμπολιτών μας και την αγάπη της κοινότητάς μας.
                            </p>
                        </motion.div>
                    </div>
                </div>
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto max-w-6xl px-4">
                    <motion.div
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Η Επίδρασή μας</h2>
                        <p className="text-xl text-gray-600">Μαζί, κάνουμε τη διαφορά στην κοινότητά μας</p>
                    </motion.div>
            ...
            <section className="py-20 bg-gray-50">
                <div className="container mx-auto max-w-6xl px-4">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Οι Αξίες μας</h2>
                        <p className="text-xl text-gray-600 max-w-2xl mx-auto">Αυτές οι βασικές αρχές καθοδηγούν όλα όσα κάνουμε</p>
                    </motion.div>
            ...
            <section className="py-20 bg-gray-50">
                <div className="container mx-auto max-w-6xl px-4">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Πώς Λειτουργούμε</h2>
                        <p className="text-xl text-gray-600 max-w-2xl mx-auto">Η ολοκληρωμένη προσέγγισή μας για τη διάσωση και την προστασία των ζώων</p>
                    </motion.div>
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto max-w-4xl px-4">
                    <motion.div
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold mb-4">Ελάτε στην Αποστολή μας</h2>
                        <p className="text-xl text-pink-100 mb-8 max-w-2xl mx-auto">
                            Είτε μέσω υιοθεσίας, φιλοξενίας, εθελοντισμού ή δωρεάς, υπάρχουν πολλοί τρόποι να κάνετε τη διαφορά.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <Button size="lg" className="border-2 border-white text-white bg-transparent hover:bg-white/10 font-bold" asChild>
