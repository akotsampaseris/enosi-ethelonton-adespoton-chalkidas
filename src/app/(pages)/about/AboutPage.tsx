...
export default function AboutPage() {
    ...
    const values = [
        ...
        },
        {
            icon: Sparkles,
            title: "Διαφάνεια",
            description: "Λειτουργούμε με ειλικρίνεια και ανοιχτότητα σε όλα όσα κάνουμε.",
        },
    ];
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
                            ...
                            <p className="text-lg text-gray-700 leading-relaxed">
                                Το έργο μας είναι δυνατό χάρη στην αφοσίωση των εθελοντών μας, τη γενναιοδωρία των δωρητών μας και την αγάπη της κοινότητάς μας.
                            </p>
                        </motion.div>
                    </div>
                </div>
