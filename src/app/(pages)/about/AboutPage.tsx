                ...
                <div className="container mx-auto max-w-6xl px-4">
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl text-pink-100 leading-relaxed">
                            Σώζουμε ζωές, ένα ζώο τη φορά, και χτίζουμε μια
                            κοινότητα όπου κάθε κατοικίδιο βρίσκει το παντοτινό
                            του σπίτι.
                        </p>
                    </motion.div>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            ...
                            <p className="text-lg text-gray-700 leading-relaxed mb-6">
                                Ιδρυθήκαμε το 2010 και είμαστε μια μη
                                κερδοσκοπική οργάνωση αφοσιωμένη στη διάσωση,
                                αποκατάσταση και επανένταξη εγκαταλελειμμένων
                                και αδέσποτων ζώων στη Χαλκίδα και τις γύρω
                                περιοχές.
                            </p>
                            <p className="text-lg text-gray-700 leading-relaxed mb-6">
                                Πιστεύουμε ότι κάθε ζώο αξίζει ένα σπίτι γεμάτο
                                αγάπη και συμπονετική φροντίδα. Μέσω των
                                προσπαθειών διάσωσης, του προγράμματος
                                φιλοξενίας και των υπηρεσιών υιοθεσίας μας,
                                έχουμε βοηθήσει εκατοντάδες ζώα να βρουν τις
                                οικογένειές τους.
                            </p>
                            <p className="text-lg text-gray-700 leading-relaxed">
                                Το έργο μας είναι δυνατό χάρη στην αφοσίωση των
                                εθελοντών μας, τη γενναιοδωρία των δωρητών μας
                                και την αγάπη της κοινότητάς μας.
                            </p>
                        </motion.div>
                    </div>
                </div>
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto max-w-6xl px-4">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                            Αφοσιωμένοι άνθρωποι που εργάζονται ακούραστα για
            ...
            <section className="py-20 bg-gray-50">
                <div className="container mx-auto max-w-6xl px-4">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                            Η ολοκληρωμένη προσέγγισή μας για τη διάσωση και την
                            προστασία των ζώων
                        </p>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            <p className="text-gray-700 leading-relaxed">
                                Ανταποκρινόμαστε σε αναφορές για
                                εγκαταλελειμμένα ή αδέσποτα ζώα, παρέχοντας
                                άμεση φροντίδα και ασφάλεια.
                            </p>
                        </motion.div>
                        ...
                        >
                            ...
                            <p className="text-gray-700 leading-relaxed">
                                Πλήρης κτηνιατρική φροντίδα, κοινωνικοποίηση και
                                φιλοξενία προετοιμάζουν τα ζώα για τα νέα τους
                                σπίτια.
                            </p>
                        </motion.div>
                        ...
                        >
                            ...
                            <p className="text-gray-700 leading-relaxed">
                                Προσεκτική αντιστοίχιση με οικογένειες γεμάτες
                                αγάπη διασφαλίζει ότι κάθε υιοθεσία είναι το
                                τέλειο ταίρι.
                            </p>
                        </motion.div>
                    </div>
                ...
                <div className="container mx-auto max-w-4xl px-4">
                    ...
                    >
                        ...
                        <p className="text-xl text-pink-100 mb-8 max-w-2xl mx-auto">
                            Είτε μέσω υιοθεσίας, φιλοξενίας, εθελοντισμού ή
                            δωρεάς, υπάρχουν πολλοί τρόποι να κάνετε τη διαφορά.
                        </p>
