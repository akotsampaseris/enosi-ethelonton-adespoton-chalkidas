    ...
    const fees = [
        {
            item: "Μικροτσίπ",
            price: "5 - 15€",
            description: "Καταχώρηση ή μεταφορά κηδεμόνα στο μικροτσίπ.",
        },
        {
            item: "Εμβόλια",
            price: "10 - 20€",
            description: "Σε περίπτωση που το ζωάκι δεν είναι ήδη εμβολιασμένο.",
        },
        {
            item: "Στείρωση",
            price: "50 - 150€",
            description: "Σε περίπτωση που το ζωάκι δεν είναι ήδη στειρωμένο.",
        },
        {
            item: "Μεταφορά",
            price: "20 - 80€",
            description: "Σε περίπτωση που δεν μπορείς να έρθεις να το παραλάβεις.",
        },
    ];
                ...
                <section className="py-20 bg-gray-50">
                    <div className="container mx-auto max-w-6xl px-4">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                            ...
                            {/* Fees */}
                            <div className="bg-white rounded-3xl border border-gray-200 p-8">
                                <h2 className="text-3xl font-bold text-gray-900 mb-6">Αρχικά Έξοδα</h2>
                                ...
                                <div className="mt-6 pt-6 border-t border-gray-200">
                                    <div className="flex items-start gap-3 bg-blue-50 rounded-xl p-4">
                                        ...
                                        <p className="text-sm text-blue-800">
                                            Κανένα από αυτά τα έξοδα δεν πληρώνονται στην οργάνωση μας. Όλες οι πληρωμές γίνονται απευθείας στις υπηρεσίες που χρησιμοποιούνται, πχ
                                            κτηνιατρείο, pet taxi.
                                        </p>
                                    </div>
                                </div>
                            </div>
