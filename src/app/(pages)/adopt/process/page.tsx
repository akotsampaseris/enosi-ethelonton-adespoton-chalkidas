  ...
  const steps = [
    {
      ...
      description:
        "Περιηγήσου στα διαθέσιμα ζωάκια μας και βρες αυτό που ταιριάζει στον τρόπο ζωής σου.",
    ...
    },
    {
      ...
      description:
        "Συμπλήρωσε την αίτηση υιοθεσίας με πληροφορίες για εσένα και το σπίτι σου.",
    ...
    },
    {
      ...
      description:
        "Κανονίζουμε μια φιλική επίσκεψη για να γνωριστούμε και να δούμε το περιβάλλον του ζώου.",
    ...
    },
    {
      ...
      description:
        "Επισκέπτεσαι το καταφύγιο για να γνωρίσεις το ζώο και να δεις αν υπάρχει chemistry.",
      duration: "1-2 ώρες",
    },
    {
      number: 5,
      ...
      description:
        "Υπογράφουμε το συμβόλαιο υιοθεσίας που διασφαλίζει την ευημερία του ζώου.",
      duration: "30 λεπτά",
    },
    {
      number: 6,
      ...
      description:
        "Παίρνεις το νέο σου φίλο σπίτι και ξεκινά η περιπέτεια σας μαζί!",
        ...
        <section className="bg-gradient-to-r from-pink-500 to-pink-600 text-white py-20">
          <div className="container mx-auto max-w-6xl px-4 text-center">
            ...
            <p className="text-xl text-pink-100 max-w-2xl mx-auto">
              Μάθε πώς μπορείς να υιοθετήσεις το νέο σου καλύτερο φίλο σε 6 απλά
              βήματα
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto max-w-5xl px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">
                Από την πρώτη γνωριμία μέχρι το νέο σας σπίτι
              </p>
            </div>
                  ...
                  <div key={step.number} className="relative pb-20 last:pb-0">
                    <div className="flex gap-2 md:gap-4 items-center">
                      ...
                      <div className="relative flex flex-col items-center flex-shrink-0">
                        ...
                        {index > 0 && (
                          <div className="w-0.5 bg-pink-300 h-65 -mt-65 mb-0" />
                        )}
                        ...
                        {index < steps.length - 1 && (
                          <div className="w-0.5 bg-pink-300 flex-1 mt-0" />
                        )}
                      </div>
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <div className="flex items-start gap-3 bg-blue-50 rounded-xl p-4">
                    ...
                    <p className="text-sm text-blue-800">
                      Το κόστος υιοθεσίας βοηθά να καλύψουμε μέρος των εξόδων
                      φροντίδας και να συνεχίσουμε να σώζουμε περισσότερα ζώα.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="container mx-auto max-w-4xl px-4">
            <div className="bg-gradient-to-r from-pink-500 to-pink-600 rounded-3xl p-12 text-center text-white">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Έτοιμος/η να Υιοθετήσεις;
              </h2>
              <p className="text-xl text-pink-100 mb-8 max-w-2xl mx-auto">
                Ξεκίνα τη διαδικασία σήμερα και δώσε σε ένα ζώο το σπίτι που του
                αξίζει
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button
                  size="lg"
                  variant="ghost"
                  className="border-2 border-white text-white hover:bg-white/10 hover:border-pink-100"
                  asChild
                >
