...
async function getRelatedPosts(currentSlug: string, categories?: string[]): Promise<BlogPost[]> {
        ...
        <PageLayout>
            <div className="min-h-screen bg-white">
                ...
                <article className="container mx-auto max-w-4xl px-4 pb-20">
                    ...
                    {/* Featured Image */}
                    <div className="relative aspect-[3/4] rounded-3xl overflow-hidden mb-12">
                        <Image src={post.mainImage} alt={post.title} fill className="object-fit" priority />
                    </div>

                    {/* Excerpt */}
                    <div className="text-xl text-gray-700 leading-relaxed mb-8 font-medium">{post.excerpt}</div>
                    ...
                    <div className="mt-12 pt-8 border-t border-gray-200">
                        <div className="bg-gray-50 rounded-2xl p-8 text-center">
                            <h3 className="text-xl font-bold text-gray-900 mb-4">Σας άρεσε αυτό το άρθρο;</h3>
                            <p className="text-gray-600 mb-6">Κοινοποιήστε το με φίλους που ενδιαφέρονται για την προστασία των ζώων</p>
                            <ShareButton
                                title={post.title}
                                text={post.excerpt}
                ...
                {relatedPosts.length > 0 && (
                    <section className="bg-gray-50 py-20">
                        <div className="container mx-auto max-w-6xl px-4">
                            <h2 className="text-3xl font-bold text-gray-900 mb-8">Σχετικά Άρθρα</h2>
