          ...
          <div className="container mx-auto max-w-6xl px-4 relative z-10">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-pink-100 mb-8 leading-relaxed">
                Κάθε δωρεά, ανεξαρτήτως ποσού, κάνει τη διαφορά στη ζωή ενός
                αδέσποτου ζώου
              </p>
            </motion.div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-6">
                  Σώζουμε, φροντίζουμε και βρίσκουμε σπίτια για εκατοντάδες
                  αδέσποτα ζώα κάθε χρόνο. Κάθε ζώο που διασώζουμε χρειάζεται:
                </p>
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  Χωρίς τη γενναιοδωρία των δωρητών μας, δεν θα μπορούσαμε να
                  συνεχίσουμε αυτό το σημαντικό έργο.
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="container mx-auto max-w-6xl px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Δείτε πώς η συνεισφορά σας κάνει πραγματική διαφορά
              </p>
            </div>
              ...
              {donationMethods.map((method) => (
                ...
                >
                  <div className="bg-pink-100 rounded-full w-16 h-16 flex items-center justify-center mb-6">
                    <method.icon className="text-pink-600" size={28} />
                  </div>
            ...
            <div className="mt-12 bg-blue-50 border border-blue-200 rounded-2xl p-6 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-blue-800">
                  Παρακαλούμε να συμπεριλάβετε το ονοματεπώνυμό σας ως
                  αιτιολογία κατάθεσης για να μπορούμε να σας στείλουμε απόδειξη
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto max-w-6xl px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">
                Δεν είναι μόνο το χρήμα - κάθε συνεισφορά μετράει
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="bg-gray-50 rounded-2xl p-8">
                <div className="flex items-start gap-4 mb-6">
                  <FileText className="text-pink-600 flex-shrink-0" size={32} />
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">
                      Ετήσιες Εκθέσεις
                    </h3>
                    <p className="text-gray-700 mb-4">
                      Κάθε χρόνο δημοσιεύουμε αναλυτική έκθεση των εσόδων και
                      εξόδων μας.
                    </p>
                  </div>
                </div>
          ...
          <div className="container mx-auto max-w-4xl px-4">
            <div className="bg-gradient-to-r from-pink-500 to-pink-600 rounded-3xl p-12 text-center text-white">
              ...
              <p className="text-xl text-pink-100 mb-8 max-w-2xl mx-auto">
                Μαζί μπορούμε να σώσουμε περισσότερες ζωές και να δώσουμε σε
                κάθε ζώο το σπίτι που του αξίζει
              </p>
