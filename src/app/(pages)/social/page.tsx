    ...
    <div className="min-h-screen bg-white pt-20">
        ...
        <div className="container mx-auto max-w-6xl px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-pink-100 leading-relaxed">
              Μοιράσου την αποστολή μας και βοήθησε περισσότερα ζώα να βρουν
              σπίτι
            </p>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto max-w-6xl px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Μείνε ενημερωμένος/η για νέα ζωάκια, υιοθεσίες και εκδηλώσεις
            </p>
          </div>
              ...
              >
                <div className="bg-white rounded-3xl border-2 border-gray-200 hover:border-pink-300 hover:shadow-2xl transition-all p-8">
                  <div className="flex items-center gap-6 mb-6">
                    <div
                      className={`${social.color} rounded-2xl p-4 text-white`}
                    >
                      <social.icon size={40} />
                    </div>
                    <div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto max-w-6xl px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Έτοιμα Μηνύματα για Κοινοποίηση
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Αντέγραψε και μοίρασε στα social media σου
            </p>
          </div>
        ...
        <div className="container mx-auto max-w-4xl px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Χρησιμοποίησε αυτά τα hashtags για να μας βοηθήσεις να φτάσουμε σε
              περισσότερο κόσμο
            </p>
          </div>
          ...
          <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
            ...
            <p className="text-center text-sm text-gray-500 mt-6">
              💡 Κλικ σε ένα hashtag για να το αντιγράψεις
            </p>
          </div>
        </div>
      </section>
                ...
                {[
                  {
                    ...
                    description:
                      "Όσο περισσότεροι βλέπουν τα ζωάκια μας, τόσο περισσότερες ευκαιρίες έχουν να βρουν σπίτι.",
                  },
                  {
                    title: "Περισσότεροι Εθελοντές",
                    description:
                      "Κάθε κοινοποίηση μπορεί να φέρει νέους εθελοντές που θα μας βοηθήσουν.",
                  },
                  {
                    title: "Περισσότερες Δωρεές",
                    description:
                      "Η ευαισθητοποίηση οδηγεί σε περισσότερη υποστήριξη για το έργο μας.",
                  },
                  {
                    title: "Ευαισθητοποίηση",
                    description:
                      "Μαζί αλλάζουμε νοοτροπίες για την προστασία των αδέσποτων ζώων.",
                  },
                ].map((item) => (
                  <div
                    key={item.title}
                    className="flex items-start gap-4 bg-white rounded-xl p-4 border border-gray-200"
                  >
                    <Heart
            ...
            >
              <div className="relative aspect-square rounded-3xl overflow-hidden shadow-2xl">
                <Image
                  ...
                  alt="Κοινοποίηση στα social media"
                  fill
        ...
        <div className="container mx-auto max-w-4xl px-4">
          <div className="bg-gradient-to-r from-pink-500 to-pink-600 rounded-3xl p-12 text-center text-white">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Κάθε Κοινοποίηση Μετράει
            </h2>
            <p className="text-xl text-pink-100 mb-8 max-w-2xl mx-auto">
              Ευχαριστούμε που μας βοηθάς να φτάσουμε σε περισσότερο κόσμο και
              να σώσουμε περισσότερες ζωές
            </p>
...
function ShareMessageCard({
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 p-6 hover:border-pink-300 hover:shadow-xl transition-all">
      ...
      <Button
        onClick={copyMessage}
        className={`w-full ${copied ? "bg-green-500 hover:bg-green-600" : "bg-pink-500 hover:bg-pink-600"}`}
      >
        {copied ? (
          <>
