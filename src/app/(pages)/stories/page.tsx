            ...
            <div className="min-h-screen bg-white">
                ...
                <section className="bg-gradient-to-r from-pink-500 to-pink-600 text-white py-20 mb-20">
                    <div className="container mx-auto max-w-6xl px-4 text-center">
                        <h1 className="text-4xl md:text-5xl font-bold mb-4">Ιστορίες Επιτυχίας</h1>
                        <p className="text-xl text-pink-100 max-w-2xl mx-auto">Γνώρισε τα ζωάκια που βρήκαν το παντοτινό τους σπίτι και τις οικογένειές τους που τα υιοθέτησαν</p>
                    </div>
                </section>
                ...
                {featured && (
                    <section className="container mx-auto max-w-6xl px-4 py-16">
                        <div className="mb-6">
                            <span className="inline-block bg-pink-100 text-pink-700 px-4 py-2 rounded-full text-sm font-semibold">⭐ Προτεινόμενη Ιστορία</span>
                        </div>
                ...
                <section className="container mx-auto max-w-6xl px-4 pb-20">
                    {regularStories.length > 0 && (
                        <>
                            <h2 className="text-3xl font-bold text-gray-900 mb-8">Όλες οι Ιστορίες</h2>
                    ...
                    {stories.length === 0 && (
                        <div className="text-center py-20">
                            <p className="text-gray-500 text-lg">Οι ιστορίες επιτυχίας μας θα είναι σύντομα διαθέσιμες!</p>
                        </div>
                    )}
                </section>
                ...
                <section className="py-20 bg-gray-50">
                    <div className="container mx-auto max-w-4xl px-4">
                        <div className="bg-gradient-to-r from-pink-500 to-pink-600 rounded-3xl p-12 text-center text-white">
                            <h2 className="text-3xl md:text-4xl font-bold mb-4">Γράψε τη Δική σου Ιστορία</h2>
                            <p className="text-xl text-pink-100 mb-8 max-w-2xl mx-auto">Υιοθέτησε ένα ζωάκι και γίνε μέρος των ευτυχισμένων τελών μας</p>
                            <Link
                                href="/animals"
