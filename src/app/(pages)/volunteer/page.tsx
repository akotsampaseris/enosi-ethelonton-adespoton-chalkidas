                    ...
                    <div className="container mx-auto max-w-6xl px-4 relative z-10">
                        ...
                        >
                            ...
                            <p className="text-xl md:text-2xl text-pink-100 mb-8 leading-relaxed">
                                Ελάτε στην ομάδα μας και βοηθήστε να κάνουμε τη
                                διαφορά στη ζωή των αδέσποτων ζώων
                            </p>
                            <Button
                                size="lg"
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            ...
                            >
                                ...
                                <p className="text-lg text-gray-700 leading-relaxed mb-6">
                                    Ο εθελοντισμός στην οργάνωσή μας σημαίνει
                                    ότι γίνεσαι μέρος μιας αποστολής που αλλάζει
                                    ζωές. Κάθε ώρα που προσφέρεις, κάθε χαμόγελο
                                    που χαρίζεις σε ένα διασωθέν ζώο, κάνει τη
                                    διαφορά.
                                </p>
                                <p className="text-lg text-gray-700 leading-relaxed mb-6">
                                    Δεν χρειάζεται προηγούμενη εμπειρία - μόνο
                                    αγάπη για τα ζώα και την επιθυμία να
                                    βοηθήσεις. Θα σε εκπαιδεύσουμε και θα σε
                    ...
                    <div className="container mx-auto max-w-6xl px-4">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                                Υπάρχουν πολλοί τρόποι να προσφέρεις - βρες
                            ...
                            {[
                                {
                                    ...
                                    title: "Επικοινωνία",
                                    description:
                                        "Στείλε μας μήνυμα με το ενδιαφέρον σου",
                                },
                                {
                                    step: "2",
                                    title: "Συνάντηση",
                                    description:
                                        "Κανονίζουμε μια συνάντηση να γνωριστούμε",
                                },
                                {
                                    step: "3",
                                    title: "Εκπαίδευση",
                                    description:
                                        "Σε εκπαιδεύουμε στον ρόλο που επέλεξες",
                                },
                                {
                                    step: "4",
                                    title: "Δράση",
                                    description:
                                        "Ξεκινάς να κάνεις τη διαφορά!",
                                },
                            ].map((item, index) => (
                                <motion.div
                                    key={item.step}
                    ...
                    <div className="container mx-auto max-w-4xl px-4">
                        <div className="bg-gradient-to-r from-pink-500 to-pink-600 rounded-3xl p-12 text-center text-white">
                            ...
                            <p className="text-xl text-pink-100 mb-8 max-w-2xl mx-auto">
                                Γίνε μέλος της ομάδας μας και βοήθησε να σώσουμε
                                περισσότερες ζωές μαζί
                            </p>
