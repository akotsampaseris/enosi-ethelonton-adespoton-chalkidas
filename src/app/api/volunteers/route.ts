...
export async function POST(request: NextRequest) {
    try {
        ...
        const { fullName, email, phone, age, city, availability, hoursPerWeek, interests, hasExperience, experience, whyVolunteer, skills, submittedAt } = body;
        ...
        const fromEmail = process.env.NODE_ENV == "development" ? "onboarding@resend.dev" : "volunteers@eeach.gr";
