...
export function Newsletter() {
  ...
  const handleSubmit = async (e: React.SubmitEvent) => {
    ...
    try {
      ...
      setStatus("success");
      setMessage(
        "✓ Καλώς ήρθες στην κοινότητα μας! Έλεγξε το email σου για να το επιβεβαιώσεις!",
      );
      setEmail("");
    } catch (error) {
      setStatus("error");
    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-pink-100 via-purple-50 to-pink-50 px-6 py-24 lg:px-8">
      ...
      >
        ...
        <p className="mt-4 text-lg text-gray-600">
          Θα λαμβάνεις τα νέα μας, τα διαθέσιμα ζωάκια μας, και τις τελευταίες
          υιοθεσίες μας.
        </p>
        ...
        <form onSubmit={handleSubmit} className="mt-10">
          ...
          <p className="mt-4 text-sm text-gray-500">
            Σεβόμαστε την ιδιωτικότητα σου. Μπορείς να βγεις όποτε θέλεις.
            Αλήθεια! 🐾
          </p>
        </form>
