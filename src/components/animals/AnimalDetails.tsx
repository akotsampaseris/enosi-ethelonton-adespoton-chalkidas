            ...
            {animal.description && (
              <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
                <h2 className="text-xl font-bold text-gray-900 mb-3">
                  Σχετικά με {animal.gender == "Αρσενικό" ? "τον" : "την"}{" "}
                  {animal.name}
                </h2>
              ...
              <div className="space-y-3 pt-4">
                ...
                >
                  <Link href={`/adopt?animal=${animal.slug}`}>
                    ...
                    Θέλω να υιοθετήσω{" "}
                    {animal.gender == "Αρσενικό" ? "τον" : "την"} {animal.name}
                  </Link>
                </Button>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Button
                    ...
                    asChild
                  >
                    <Link href={`/foster?animal=${animal.slug}`}>
                      Φιλοξενία
                    </Link>
                  </Button>
                  <ShareButton
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="bg-gradient-to-r from-pink-500 to-pink-600 rounded-3xl p-12 text-center text-white">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Έχουμε και άλλα υπέροχα ζωάκια!
            </h2>
            <p className="text-xl text-pink-100 mb-8 max-w-2xl mx-auto">
              Δες και τα υπόλοιπα ζωάκια που περιμένουν το παντοτινό τους σπίτι
            </p>
            <Button
              size="lg"
