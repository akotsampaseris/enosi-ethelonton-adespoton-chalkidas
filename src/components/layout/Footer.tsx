          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-sm leading-6 text-gray-300">
                Διασώζουμε, φροντίζουμε και βρίσκουμε ένα σπίτι για τα αδέσποτα
                ζώα στον δήμο μας. Σε κάθε ζώο αξίζει ένα ζεστό σπίτι.
              </p>
            </div>
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
            <p className="text-xs leading-5 text-gray-400">
              © {new Date().getFullYear()} Ένωση Εθελοντών Αδέσποτων Χαλκίδας.
              All rights reserved.
            </p>
            <div className="flex items-center gap-2 text-xs text-gray-400">
              Made with{" "}
              <Heart className="h-3 w-3 fill-pink-500 text-pink-500" /> for
              animals by
              <Link
