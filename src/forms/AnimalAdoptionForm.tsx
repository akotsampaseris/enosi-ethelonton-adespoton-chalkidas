            ...
            <div>
              ...
              {animal && (
                <p className="text-pink-100 text-lg font-semibold">
                  για {animal.gender == "Αρσενικό" ? "τον" : "την"}{" "}
                  {animal.name}
                </p>
              )}
            </div>
            ...
            <div className="flex items-center gap-4 bg-white rounded-2xl p-4 border border-gray-200">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  ...
                  {animal.age === 1 ? "έτους" : "χρονών"} • {animal.gender}
                </p>
              </div>
            </div>
          </div>
                      ...
                      <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                        ...
                        <div className="space-y-1 leading-none">
                          <FormLabel className="font-normal cursor-pointer">
                            Συμφωνώ σε επίσκεψη στο σπίτι μου πριν την υιοθεσία
                          </FormLabel>
                          <FormMessage />
                        </div>
                      </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                        ...
                        <div className="space-y-1 leading-none">
                          <FormLabel className="font-normal cursor-pointer">
                            Συμφωνώ σε follow-up επικοινωνίες μετά την υιοθεσία
                          </FormLabel>
                          <FormMessage />
                        </div>
                      </FormItem>
