        ...
        <div className="container mx-auto max-w-4xl px-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              {animal && (
                <p className="text-pink-100 text-lg">για το {animal.name}</p>
              )}
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700">
                Η φιλοξενία είναι προσωρινή φροντίδα για ένα ζώο μέχρι να βρεθεί
                το μόνιμο σπίτι του. Η οργάνωση μας καλύπτει τα έξοδα κτηνιάτρου
                και τροφής. Εσείς προσφέρετε αγάπη και ένα ασφαλές σπίτι!
              </p>
            </div>
          </div>
        </div>
        ...
        {submitStatus === "success" ? (
          ...
          >
            ...
            <p className="text-green-700 mb-6">
              Θα επικοινωνήσουμε μαζί σας σύντομα για να συζητήσουμε τα επόμενα
              βήματα.
            </p>
                ...
                <div className="space-y-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Πόσο καιρό μπορείτε να φιλοξενήσετε; *
                        </FormLabel>
                        <Select
                          onValueChange={field.onChange}
                          value={field.value}
                  ...
                  <FormField
                    ...
                    render={() => (
                      <FormItem>
                        <FormLabel>
                          Τι τύπους ζώων μπορείτε να φιλοξενήσετε; * (επιλέξτε
                          όσα θέλετε)
                        </FormLabel>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Μπορείτε να φιλοξενήσετε ζώα με ιατρικές ανάγκες; *
                        </FormLabel>
                        <Select
                          onValueChange={field.onChange}
                          value={field.value}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Μπορείτε να μεταφέρετε το ζώο σε ραντεβού κτηνιάτρου;
                          *
                        </FormLabel>
                        <Select
                          onValueChange={field.onChange}
                ...
                <div className="space-y-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Έχετε αναθρέψει ζώα στο παρελθόν; *
                        </FormLabel>
                        <Select
                          onValueChange={field.onChange}
                          value={field.value}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Έχετε άλλα κατοικίδια αυτή τη στιγμή;
                        </FormLabel>
                        <FormControl>
                          <Textarea
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Έχετε φιλοξενήσει ζώα στο παρελθόν; *
                        </FormLabel>
                        <Select
                          onValueChange={field.onChange}
                          value={field.value}
              ...
              <section className="bg-white rounded-2xl border border-gray-200 p-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Πείτε μας για τους λόγους που θέλετε να φιλοξενήσετε{" "}
                        {animal ? `το ${animal.name}` : "ένα ζώο"} *
                      </FormLabel>
                      <FormControl>
                        <Textarea
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                        ...
                        <div className="space-y-1 leading-none">
                          <FormLabel className="font-normal cursor-pointer">
                            Καταλαβαίνω ότι η φιλοξενία είναι προσωρινή και
                            συμφωνώ να επιστρέψω το ζώο όταν βρεθεί μόνιμο σπίτι
                          </FormLabel>
                          <FormMessage />
                        </div>
                      </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                        ...
                        <div className="space-y-1 leading-none">
                          <FormLabel className="font-normal cursor-pointer">
                            Συμφωνώ να ακολουθώ τις οδηγίες της οργάνωσης για τη
                            φροντίδα του ζώου
                          </FormLabel>
                          <FormMessage />
                        </div>
