...
export default function VolunteerApplicationForm() {
    ...
    const volunteerRoles = [
        { id: "fostering", label: "Προσωρινή φιλοξενία αδέσποτων" },
        { id: "feeding", label: "Σίτιση αδέσποτων" },
        { id: "transfering", label: "Μεταφορά ζώων (σε κτηνίατρο, υιοθεσία κλπ)" },
        { id: "admin", label: "Καταγραφή & επίβλεψη αδέσποτων" },
        { id: "events", label: "Οργάνωση δράσεων και εκδηλώσεων" },
        { id: "photography", label: "Φωτογραφία & Βίντεο" },
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Textarea placeholder="π.χ. Φωτογραφία, design, social media, οδήγηση, οργάνωση εκδηλώσεων..." rows={3} {...field} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
