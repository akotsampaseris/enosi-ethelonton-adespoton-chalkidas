...
const volunteerFormSchema = z.object({
  ...
  interests: z
    .array(z.string())
    .min(1, "Επιλέξτε τουλάχιστον έναν τομέα ενδιαφέροντος"),
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700">
                Συμπληρώστε την αίτηση και θα επικοινωνήσουμε μαζί σας σύντομα
        ...
        {submitStatus === "success" ? (
          ...
          >
            ...
            <p className="text-green-700 mb-6">
              Θα επικοινωνήσουμε μαζί σας σύντομα για να σας ενημερώσουμε για τα
              επόμενα βήματα.
            </p>
                ...
                <div className="space-y-6">
                  <FormField
                    ...
                    render={() => (
                      <FormItem>
                        <FormLabel>
                          Ποιες μέρες είστε διαθέσιμος/η; * (επιλέξτε όσες
                          θέλετε)
                        </FormLabel>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Πόσες ώρες την εβδομάδα μπορείτε να διαθέσετε; *
                        </FormLabel>
                        <Select
                          onValueChange={field.onChange}
                          value={field.value}
              ...
              <section className="bg-white rounded-2xl border border-gray-200 p-6">
                ...
                <FormField
                  ...
                  render={() => (
                    <FormItem>
                      <FormLabel>
                        Σε ποιους τομείς θα θέλατε να βοηθήσετε; * (επιλέξτε
                        όσους θέλετε)
                      </FormLabel>
                ...
                <div className="space-y-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Έχετε εμπειρία με ζώα ή εθελοντισμό; *
                        </FormLabel>
                        <Select
                          onValueChange={field.onChange}
                          value={field.value}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Αν ναι, περιγράψτε την εμπειρία σας
                        </FormLabel>
                        <FormControl>
                          <Textarea
                            placeholder="π.χ. Εθελοντής σε άλλο καταφύγιο, ιδιοκτήτης κατοικιδίων..."
                            rows={3}
                            {...field}
                          />
                        </FormControl>
                ...
                <div className="space-y-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea
                            placeholder="Μοιραστείτε τους λόγους σας..."
                            rows={5}
                            {...field}
                          />
                        </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Ειδικές δεξιότητες που θα μπορούσαν να βοηθήσουν
                          (προαιρετικό)
                        </FormLabel>
                        <FormControl>
                          <Textarea
                            placeholder="π.χ. Φωτογραφία, σχεδιασμός, social media, οδήγηση, οργάνωση εκδηλώσεων..."
                            rows={3}
                            {...field}
                          />
                        </FormControl>
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                      ...
                      <div className="space-y-1 leading-none">
                        <FormLabel className="font-normal cursor-pointer">
                          <span>
                            Καταλαβαίνω ότι ο εθελοντισμός απαιτεί δέσμευση και
                            υπευθυνότητα. Συμφωνώ να ακολουθώ τις οδηγίες της
                            οργάνωσης και να σεβαστώ τους{" "}
                            <Link
                              href="/terms#volunteer"
